...
<head>
    ...
    <meta name="csrf-token" content="uF4JqPIghMM9CJb3ntTCXDxdC5Dcxucz6WXG3R1s">
    ...
    <app inline-template>
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                <a href="http://mysteryshop2.test/home"
                   class="brand-link ">
                    <img src="http://mysteryshop2.test/vendor/adminlte/dist/img/AdminLTELogo.png"
                         alt="AdminLTE"
                ...
                <div class="sidebar">
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column "
                            ...
                            <li class="nav-item ">
                                <a class="nav-link  " href="http://mysteryshop2.test/admin/pages">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link  " href="http://mysteryshop2.test/admin/settings">
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div>
                        <p>Welcome erererererermin panel. {!! $link !!}</p>
